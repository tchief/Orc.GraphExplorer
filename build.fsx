...
let binProjectName = "Orc.GraphExplorer"
...
let projectsToPackageAssemblyNames = ["Orc.GraphExplorer"]
let projectsToPackageDependencies:^string list = ["Catel.Core";"Catel.MVVM";"fasterflect";"Orc.FilterBuilder";"Orc.Toolkit"]
